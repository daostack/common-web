...
export const ITEMS: Item[] = [
  {
    ...
    name: "Project 1",
    image: IMAGE_URL,
    path: getCommonPagePath("project-1"),
  },
  {
    id: "project-2",
    name: "Project 2",
    image: IMAGE_URL,
    path: getCommonPagePath("project-2"),
    items: [
      {
        id: "project-2.1",
        name: "Project 2.1",
        image: IMAGE_URL,
        path: getCommonPagePath("project-2.1"),
        ...
        items: [
          {
            ...
            name: "Project 2.1.1",
            image: IMAGE_URL,
            path: getCommonPagePath("project-2.1.1"),
            items: [
              {
                id: "project-2.1.1.1",
                name: "Project 2.1.1.1",
                image: IMAGE_URL,
                path: getCommonPagePath("project-2.1.1.1"),
              },
              {
                id: "project-2.1.1.2",
                name: "Project 2.1.1.2",
                image: IMAGE_URL,
                path: getCommonPagePath("project-2.1.1.2"),
                hasMembership: false,
                items: [
                  {
                    ...
                    image: IMAGE_URL,
                    path: getCommonPagePath("project-2.1.1.2.1"),
                  ...
                  },
                  {
                    ...
                    image: IMAGE_URL,
                    path: getCommonPagePath("project-2.1.1.2.2"),
                    hasMembership: false,
                  },
                ],
              },
          ...
          },
          {
            ...
            name: "Project 2.1.2",
            image: IMAGE_URL,
            path: getCommonPagePath("project-2.1.2"),
          },
        ],
      },
    ],
  },
  {
    ...
    name: "Project 3",
    image: IMAGE_URL,
    path: getCommonPagePath("project-3"),
  },
];
