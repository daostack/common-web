...
import { FundsAllocation, isFundsAllocationProposal } from "@/shared/models/governance/proposals";
import { transformFirebaseDataSingle } from "@/shared/utils";
import firebase from "@/shared/utils/firebase";

export async function fetchProposal(proposalId: string): Promise<FundsAllocation | null> {
