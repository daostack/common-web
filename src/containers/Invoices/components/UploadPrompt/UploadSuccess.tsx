...
export default function UploadSuccess({ closePrompt, updateSubmissionStatus }: IProps) {
  ...
  return (
    <div className="upload-success-wrapper">
      ...
      <button className="button-blue" onClick={() => { closePrompt(); updateSubmissionStatus(); }}>Done</button>
    </div>
  )
}
