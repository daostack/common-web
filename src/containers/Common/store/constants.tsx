export enum CommonsActionTypes {
  ...
  OPEN_MODERATE_MODAL = "@COMMONS/OPEN_MODERATE_MODAL",

  REPORT_ITEM = "@COMMONS/REPORT_ITEM",
  REPORT_ITEM_SUCCESS = "@COMMONS/REPORT_ITEM_SUCCESS",
  REPORT_ITEM_FAILURE = "@COMMONS/REPORT_ITEM_FAILURE",

  HIDE_ITEM = "@COMMONS/HIDE_ITEM",
  HIDE_ITEM_SUCCESS = "@COMMONS/HIDE_ITEM_SUCCESS",
  HIDE_ITEM_FAILURE = "@COMMONS/HIDE_ITEM_FAILURE",
}
