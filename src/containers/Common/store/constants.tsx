export enum CommonsActionTypes {
  ...
  CREATE_COMMON_PAYMENT = "@COMMONS/CREATE_COMMON_PAYMENT",
  CREATE_COMMON_PAYMENT_SUCCESS = "@COMMONS/CREATE_COMMON_PAYMENT_SUCCESS",
  CREATE_COMMON_PAYMENT_FAILURE = "@COMMONS/CREATE_COMMON_PAYMENT_FAILURE",

  CLEAR_CURRENT_COMMON_PAYMENT = "@COMMONS/CLEAR_CURRENT_COMMON_PAYMENT",
