export enum CommonsActionTypes {
  ...
  UPDATE_GOVERNANCE = "@COMMONS/UPDATE_GOVERNANCE",
  UPDATE_GOVERNANCE_SUCCESS = "@COMMONS/UPDATE_GOVERNANCE_SUCCESS",
  UPDATE_GOVERNANCE_FAILURE = "@COMMONS/UPDATE_GOVERNANCE_FAILURE",
