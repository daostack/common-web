...
import { ContributionType, MIN_CONTRIBUTION_ILS_AMOUNT, ScreenSize } from "@/shared/constants";
...
export default function PersonalContribution(props: PersonalContributionProps) {
  ...
  const minFeeToJoin = memberAdmittanceOptions.minFeeMonthly?.amount || memberAdmittanceOptions.minFeeOneTime?.amount || MIN_CONTRIBUTION_ILS_AMOUNT;
