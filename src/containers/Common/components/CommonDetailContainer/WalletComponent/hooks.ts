...
import { BRIEF_MONTH_NAMES, TRANSACTIONS_PERIOD_MONTHS_AMOUNT } from "./constants";
...
export const useCommonTransactionsChartDataSet = (): UseCommonTransactionsChartDataReturn => {
