export enum CacheActionType {
  ...
  GET_CHAT_MESSAGE_USER_STATUS = "@CACHE/GET_CHAT_MESSAGE_USER_STATUS",
  GET_CHAT_MESSAGE_USER_STATUS_SUCCESS = "@CACHE/GET_CHAT_MESSAGE_USER_STATUS_SUCCESS",
  GET_CHAT_MESSAGE_USER_STATUS_FAILURE = "@CACHE/GET_CHAT_MESSAGE_USER_STATUS_FAILURE",

  UPDATE_CHAT_MESSAGE_USER_STATUS = "@CACHE/UPDATE_CHAT_MESSAGE_USER_STATUS",
}
