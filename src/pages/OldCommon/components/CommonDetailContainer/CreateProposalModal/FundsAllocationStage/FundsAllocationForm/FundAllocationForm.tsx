...
import { FundDetails } from "@/pages/OldCommon/components/CommonDetailContainer/CreateProposalModal/FundsAllocationStage/FundDetails";
  ...
  return (
    <div className="funds-allocation-form">
      <StageName
        ...
        icon={<DollarIcon className="funds-allocation-form__avatar-icon" />}
      />
