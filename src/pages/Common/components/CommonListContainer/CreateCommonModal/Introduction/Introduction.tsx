...
const SLIDES: SlideOptions[] = [
  ...
  },
  {
    ...
    description:
      "Invite others to join your Common. Easily pool funds from all members and work together to advance your cause.",
  },
  {
    imageSrc: "/assets/images/membership-request-vote.svg",
    title: "Work as a collective",
    description:
      "All members get an equal vote and can take part in the shared effort.",
  },
  {
    imageSrc: "/assets/images/membership-request-membership.svg",
    title: "Harness the power of communities",
    description:
      "There‘s no limit to what we can achieve when working together. By getting everyone involved, more people will actively promote the cause.",
  },
];
    ...
    <>
      <div className="create-common-introduction">
        <Swiper
          pagination={{
            clickable: true,
            bulletActiveClass: "create-common-introduction__active-bullet",
          }}
            ...
            <SwiperSlide key={slide.title}>
              <figure className="create-common-introduction__slide">
                <img
                  ...
                  alt={slide.title}
                />
                <figcaption className="create-common-introduction__slide-title">
                  {slide.title}
                </figcaption>
                <figcaption className="create-common-introduction__slide-description">
                  {slide.description}
                </figcaption>
              </figure>
            </SwiperSlide>
