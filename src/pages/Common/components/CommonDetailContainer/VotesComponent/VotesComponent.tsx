...
import { useProposalUserVote } from "@/pages/Common/hooks";
      ...
      compactCard ? (
        ...
        <div className="votes-wrapper">
          ...
          <div className="votes-columns-container">
            <div
              className={classNames("vote-column", {
                voted: userVote?.outcome === VoteOutcome.Approved,
              })}
            >
              {percentage(votesFor, totalVotes)}%
              {!compact && (
            ...
            <div
              className={classNames("vote-column", {
                voted: userVote?.outcome === VoteOutcome.Abstained,
              })}
            >
              {percentage(votesAbstained, totalVotes)}%
              {!compact && (
            ...
            <div
              className={classNames("vote-column", {
                voted: userVote?.outcome === VoteOutcome.Rejected,
              })}
            >
              {percentage(votesAgainst, totalVotes)}%
              {!compact && (
