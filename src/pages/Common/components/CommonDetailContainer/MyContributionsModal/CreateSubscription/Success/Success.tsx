...
const Success: FC<SuccessProps> = (props) => {
  ...
  const contentEl = (
    <section className="monthly-success-my-contributions-stage">
      <img
        className="monthly-success-my-contributions-stage__image"
        src="/assets/images/membership-request-created.svg"
        alt="Request created"
      />
      <h3 className="monthly-success-my-contributions-stage__title">
        Contribution was sent
      </h3>
      <Button
        className="monthly-success-my-contributions-stage__button"
        onClick={onFinish}
