...
const getPaymentContent = (
  ...
  const amount = subscription?.price.amount || payment.price.amount;
      ...
      >
        <div
          className={classNames(
            ...
            {
              "billing-contribution-list-item__title-wrapper--centered":
                !description,
            },
          )}
        >
        ...
        <div className="billing-contribution-list-item__status-container">
          <div
            className={classNames(
              ...
              {
                "billing-contribution-list-item__status-wrapper--centered":
                  !statusDescription,
              },
            )}
          >
