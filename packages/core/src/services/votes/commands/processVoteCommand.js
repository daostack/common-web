...
exports.processVoteCommand = void 0;
var _logger_1 = require("@logger");
var _toolkits_1 = require("@toolkits");
var _errors_1 = require("@errors");
var _services_1 = require("@services");
var processVoteCommand = function (voteId) { return __awaiter(void 0, void 0, void 0, function () {
    var vote;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, _toolkits_1.prisma.vote.findUnique({
                    where: {
                        id: voteId
                    }
                })];
...
exports.processVoteCommand = processVoteCommand;
