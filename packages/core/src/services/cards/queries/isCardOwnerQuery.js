...
exports.isCardOwnerQuery = void 0;
 ...
 */
var isCardOwnerQuery = function (cardId, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var card;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, _toolkits_1.prisma.card.findUnique({
                    where: {
                        id: cardId
                    },
                    select: {
            ...
            case 1:
                ...
                if (!card) {
                    throw new _errors_1.NotFoundError('card', cardId);
                }
                return [2 /*return*/, card.userId === userId];
        }
    });
}); };
exports.isCardOwnerQuery = isCardOwnerQuery;
