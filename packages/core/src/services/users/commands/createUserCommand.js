...
var createUserCommand = function (command) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            // Basic validation on the payload
            return [4 /*yield*/, schema.parseAsync(command)];
            case 1:
                // Basic validation on the payload
                _a.sent();
                return [4 /*yield*/, _toolkits_1.prisma.user.create({
                        data: __assign({}, command)
                    })];
            case 2:
                user = _a.sent();
